...
```{r pseudo_data, eval=F, results='hide'}
library(HDChangePoint)
...
```{r data_info, eval=FALSE, message=FALSE}
...
```{r pseudo_analysis, message=FALSE, eval=FALSE, results='hide'}
